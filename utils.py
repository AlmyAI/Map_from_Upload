...
def get_dataframe(varDevice):
  if varDevice == 'accent_prime':
    df = pd.read_csv('data/accent_prime.csv')
  elif varDevice == 'harmony':
    df = pd.read_csv('data/harmony.csv')
  elif varDevice == 'duo':
    df = pd.read_csv('data/duo.csv')
  elif varDevice == 'all':
    df = pd.read_csv('data/accent_prime.csv')
  return df

def get_dataframe_filtered(varDevice):
  df = filter_dataframe(varDevice, "df" + varDevice)
  return df
